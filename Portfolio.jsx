...
/**
 * Mahip Patel — Personal Portfolio
 * Single-file React component. Drop into any React app (CRA, Vite, Next.js)
 * or open the included index.html in a browser to preview.
 *
 * To use your photo: place `profile.jpg` in the same folder as this file
 * (or update PROFILE_IMAGE below). Same for `Mahip_Resume.pdf`.
 */

const PROFILE_IMAGE = "./profile.jpg";
const RESUME_PDF = "./Mahip_Resume.pdf";

const data = {
  name: "Mahip Patel",
  tagline: "Software Engineer · M.S. Computer Science",
  location: "Texas, USA",
  email: "mahiptexas@gmail.com",
  phone: "+1 (512) 665-9294",
  github: "https://github.com/mahip-patel",
  linkedin: "https://www.linkedin.com/in/mahip-patel",
  about:
  ...
  experience: [
    ...
    {
      role: "Web Scraping & Web Design (Voluntary)",
      org: "Texas A&M University–Corpus Christi",
      location: "Corpus Christi, TX",
      dates: "Summer 2025",
      bullets: [
        "Automated data extraction for faculty research by building Python-based web scraping pipelines.",
        "Enhanced internal university webpages through improved layout structure, accessibility, and UI/UX styling.",
      ],
    },
    {
      role: "Web Developer",
    ...
    },
    {
      ...
      org: "Bhagwati Hardware",
      location: "Vadodara, India",
      dates: "Jan 2022 – Dec 2023",
      bullets: [
        "Designed SQL/Power BI dashboards for pricing analysis and business reporting to support leadership decisions.",
        "Cleaned and structured operational datasets, improving accuracy, reducing report time, and optimizing data workflows.",
      ],
    },
    {
      ...
      bullets: [
        "Developed a PHP-based student management system with secure authentication and course tracking.",
        "Optimized backend logic and SQL queries to reduce database load and improve application performance.",
      ],
    },
  ],
  education: [
    ...
    {
      school: "GSFC University, Vadodara",
  ...
  skills: [
    { group: "Programming", items: ["Python", "Java", "JavaScript", "PHP", ".NET"] },
    { group: "Web / Frontend", items: ["HTML/CSS", "React.js", "WordPress"] },
    { group: "Data & Analytics", items: ["Power BI", "Excel", "Tableau", "NumPy", "Pandas"] },
    { group: "Databases", items: ["MySQL", "MongoDB", "Redis"] },
    { group: "Cloud / DevOps", items: ["AWS EC2", "Docker", "Git", "GitHub"] },
    { group: "Other", items: ["Graphic Design", "Digital Marketing"] },
  ],
  projects: [
    {
      name: "SmartAssist — AI-Powered Smart Campus Assistant",
      blurb:
        "An AI-driven campus assistant with a custom RAG pipeline that answers FAQs, automates assignment evaluation feedback, and orchestrates agent-based workflows.",
      tech: ["Python", "FastAPI", "LLMs", "MongoDB", "RAG"],
    },
    {
      name: "Online Food Ordering System",
      blurb:
        "Full-stack food ordering platform with secure login, menu management, and real-time order tracking. Tuned database operations for low latency.",
      tech: ["Java", "Servlets", "JDBC", "JSP", "HTML/CSS"],
    },
    {
      name: "Smart Plan Weather System",
      blurb:
...
export default function Portfolio() {
  ...
  return (
    <div className="portfolio-root">
      ...
      <header className={`nav ${scrolled ? "nav--scrolled" : ""}`}>
        <div className="nav__inner">
          ...
          <nav className={`nav__links ${navOpen ? "is-open" : ""}`}>
            {["about", "experience", "education", "skills", "projects", "contact"].map((s) => (
              <a key={s} onClick={() => scrollTo(s)}>
                {s.charAt(0).toUpperCase() + s.slice(1)}
              </a>
            ))}
            <a className="nav__cta" href={RESUME_PDF} target="_blank" rel="noreferrer">
              Resume ↗
            </a>
          </nav>
          <button
        ...
        <div className="container hero__inner">
          <div className="hero__copy" data-reveal>
            ...
            <h1 className="hero__title">
              Hi, I'm <span className="accent">Mahip</span>.
            </h1>
            <p className="hero__tagline">{data.tagline}</p>
            <p className="hero__sub">
              Building thoughtful software at the intersection of full‑stack engineering,
              data, and applied AI.
            </p>
            <div className="hero__cta">
              ...
              <a className="btn btn--ghost" href={RESUME_PDF} target="_blank" rel="noreferrer">
                View résumé
              </a>
            </div>
          ...
          <div className="hero__photo" data-reveal>
            <div className="photo-frame">
              <img src={PROFILE_IMAGE} alt="Mahip Patel" onError={(e) => {
      ...
      <Section id="about" eyebrow="01 — About" title="A bit about me">
        <div className="about" data-reveal>
          ...
          <div className="about__stats">
            <Stat number="5+" label="Roles & internships" />
            <Stat number="3" label="Featured projects" />
            <Stat number="6+" label="Tech stacks" />
          </div>
        </div>
      </Section>
            ...
            <li key={i} className="timeline__item" data-reveal>
              ...
              <div className="timeline__card">
                ...
                <p className="timeline__org">
                  {e.org} <span className="dot">•</span> <em>{e.location}</em>
                </p>
      ...
      {/* EDUCATION */}
      <Section id="education" eyebrow="03 — Education" title="Academic background">
        <div className="grid grid--2">
          {data.education.map((ed, i) => (
            <div key={i} className="card education-card" data-reveal>
              <h3>{ed.school}</h3>
              <p className="education-card__degree">{ed.degree}</p>
              <div className="education-card__meta">
                <span>{ed.dates}</span>
                <span className="pill pill--gold">{ed.detail}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <Section id="skills" eyebrow="04 — Skills" title="Tools of the trade">
        <div className="skills">
          {data.skills.map((g, i) => (
            <div key={i} className="skills__group" data-reveal>
              <h4>{g.group}</h4>
      ...
      <Section id="projects" eyebrow="05 — Projects" title="Selected work">
        <div className="grid grid--3">
          {data.projects.map((p, i) => (
            <article key={i} className="card project" data-reveal>
              <div className="project__num">0{i + 1}</div>
              <h3>{p.name}</h3>
              <p>{p.blurb}</p>
        ...
        <div className="contact">
          <div className="contact__info" data-reveal>
            <p className="contact__lead">
              I'm always open to interesting opportunities, collaborations, or just a good
              conversation about software and design. Drop me a line.
            </p>
            <ul className="contact__list">
              ...
              <li>
                ...
                <a href={data.linkedin} target="_blank" rel="noreferrer">
                  linkedin.com/in/mahip-patel
                </a>
              </li>
              <li>
                <span className="contact__label">GitHub</span>
                <a href={data.github} target="_blank" rel="noreferrer">
                  github.com/mahip-patel
                </a>
              </li>
            </ul>
          </div>
      ...
      <footer className="footer">
        <div className="container footer__inner">
          <p>© {new Date().getFullYear()} Mahip Patel. Crafted with care.</p>
...
.hero__bg {
  ...
  background:
    radial-gradient(900px 480px at 85% -10%, rgba(184,145,90,.18), transparent 60%),
    radial-gradient(700px 420px at 0% 100%, rgba(10,37,64,.08), transparent 60%);
  pointer-events: none;
}
.hero__inner {
  display: grid;
...
.photo-frame--fallback .photo-frame__fallback { display: flex; }
...
.section:nth-of-type(even) .timeline__dot { border-color: var(--bg-alt); }
.timeline__card {
  background: var(--white);
  padding: 24px 26px;
  border-radius: var(--radius);
...
.timeline__org em { color: var(--slate-light); font-weight: 400; font-style: normal; }
...
.timeline__bullets li::marker { color: var(--gold); }
...
@media (max-width: 900px) {
  ...
  .hero__photo { order: -1; }
  .photo-frame { width: min(280px, 70vw); }
